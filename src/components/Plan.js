  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <div>
          <button className='border-black mr-4 hover:shadow-xl hover:bg-black hover:text-white ease-in-out duration-500'>
            Learn More
          </button>
          <a href='https://www.booking.com/' target='_blank' rel='noreferrer'>
            <button className='bg-black text-white border-black hover:shadow-xl hover:bg-white hover:text-black ease-in-out duration-500'>
              Book Your Trip
            </button>
          </a>
        </div>
